       ...
       return(
         <div className="BannerDiv">
           ...
           <Row className="BannerRow">
              <Col>
              <p className="BannerTitle">  <img className="Banner" src={Star} alt="PiesFajnyJest, wspieraj, adoptuj, pomagaj!" /> <span className="textBanner">PiesFajnyJest - Trochę o nas</span></p>
             ...
             <Row className="BannerRow">
                ...
                <Col>
                <p className="BannerTitle">  <img className="Banner" src={Star} alt="PiesFajnyJest, wspieraj, adoptuj, pomagaj!" /> <span className="textBanner">PiesFajnyJest - Warto Pomagać!</span></p>
